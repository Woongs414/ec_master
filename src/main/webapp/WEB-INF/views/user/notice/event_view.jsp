...
<script type="text/javascript">
	...
	function backToList(obj){
		obj.action="${contextPath}/user/event";
		obj.submit();
	}	
</script>
</head>
<body>
<div id="title_img">
	<img src="${contextPath}/image/event_title.png" style="padding-left:150px">
	</div>
	<div id="write">
		<table align="center" class="table">
			...
			<tr>
				...
				<img src="${contextPath}/event/download?list_num=${notice.list_num}&image_fileName=${notice.image_fileName}">
				</td>
			</tr>
			<tr>
